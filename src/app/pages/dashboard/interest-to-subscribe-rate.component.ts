...
@Component({
  selector: 'app-interest-to-subscribe-rate',
  template: `
    <app-kpi-card
      [title]="title"
      [subtitle]="subtitle"
...
export class InterestToSubscribeRateComponent {
  readonly title = 'Conversão interesse para inscrição';
  readonly subtitle = 'Leads interessados que viram inscrições';
  readonly valueSuffix = '%';
  readonly valueFormat = '1.0-1';
  readonly changeFormat = '1.0-1';
  readonly changeLabel = 'vs semana anterior';
  readonly trendAriaLabel = 'Tendencia da conversao';
