...
export type EnumType =
  ...
  | 'situacaoBoleto'
  | 'contexto'
  | 'cieloCheckoutPaymentStatus'
  | 'tipoTransacao'
  | 'modalidadeProcessoSeletivo'
  | 'tipoIntegracaoArquivo'
  | 'tipoInstituicaoEnsinoMedio'
  | 'tipoProcessoSeletivo'
  | 'orgaoEmissorRg'
  | 'tipoModalidade'
  | 'condicao'
  | 'servico'
  ...
  | 'inscricaoEtapa'
  | 'grauFormacao'
  | 'tipoAprovacaoContrato'
  | 'estadoCivil'
  | 'formatoAvaliacao'
  | 'tipoFeriado'
  | 'erpIntegracao'
  | 'visibilidade'
  | 'plataformaConsumidor'
  | 'modalidadeAvaliacao'
  | 'environment'
  | 'inscricaoEtapaSituacao'
  | 'httpMethod'
  | 'ambienteAvaliacao'
  | 'moeda'
  | 'voto';
